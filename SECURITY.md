...
<https://github.com/voicetel/scala-sdk/security/advisories/new>).
...
- The SDK uses sttp with the JVM's default TLS posture (TLS 1.2+,
  session resumption via the JSSE session cache). If you supply a
  custom sttp backend, you are responsible for matching that posture.
...
Out of scope: vulnerabilities in the `com.voicetel:voicetel-sdk-scala`
